...
function mqtt_do()
	m:connect(
		"a137oBqUiTV.iot-as-mqtt.cn-shanghai.aliyuncs.com",
		1883,
		0,
		0,
		function(client)
	...
	tmr.alarm(
		...
		function()
			...
			elseif ready == "wifiok" then
				...
				m =
					mqtt.Client(
					"jmiNPT1yRCaa41rdGa2o|securemode=3,signmethod=hmacsha1|",
					70,
					"jmiNPT1yRCaa41rdGa2o&a137oBqUiTV",
					"28BF18C52671FDD489004DB74D989A2B48ED88F5",
					1
				)
				m:on(
					"connect",
